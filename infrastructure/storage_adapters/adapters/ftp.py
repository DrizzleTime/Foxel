...
class FTPAdapter:
    ...
    async def mkdir(self, root: str, rel: str):
        ...
        await logging_service.info("adapter:ftp", f"Created directory {rel}", details={"adapter_id": self.record.id, "path": path})
    ...
    async def delete(self, root: str, rel: str):
        ...
        await logging_service.info("adapter:ftp", f"Deleted {rel}", details={"adapter_id": self.record.id, "path": path})
    ...
    async def move(self, root: str, src_rel: str, dst_rel: str):
        ...
        await logging_service.info("adapter:ftp", f"Moved {src_rel} to {dst_rel}", details={"adapter_id": self.record.id, "src": src, "dst": dst})
    ...
    async def copy(self, root: str, src_rel: str, dst_rel: str, overwrite: bool = False):
        ...
        await logging_service.info("adapter:ftp", f"Copied {src_rel} to {dst_rel}", details={"adapter_id": self.record.id, "src": src, "dst": dst})
