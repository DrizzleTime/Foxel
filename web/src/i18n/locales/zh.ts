...
export const zh = {
  ...
  'Configure system domains': '配置系统域名',
  'Set application and file access domains': '设置应用访问域名和文件访问域名',
  'Please input app domain!': '请输入应用域名！',
  'Please input file domain!': '请输入文件域名！',
  'e.g., https://foxel.example.com': '例如: https://foxel.example.com',
