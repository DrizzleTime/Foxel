export const en = {
  ...
  'Configure system domains': 'Configure system domains',
  'Set application and file access domains': 'Set application and file access domains',
  'Please input app domain!': 'Please input app domain!',
  'Please input file domain!': 'Please input file domain!',
  'e.g., https://foxel.example.com': 'e.g., https://foxel.example.com',
