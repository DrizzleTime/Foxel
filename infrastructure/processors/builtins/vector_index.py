...
from application.ai.inference import describe_image_base64, get_text_embedding
from application.ai.dependencies import ai_use_cases
from application.logging.dependencies import logging_service
from infrastructure.vector_db.service import DEFAULT_VECTOR_DIMENSION, VectorDBService
...
class VectorIndexProcessor:
    ...
    async def process(self, input_bytes: bytes, path: str, config: Dict[str, Any]) -> Response:
        ...
        embedding_model = await ai_use_cases.get_default_model("embedding")
