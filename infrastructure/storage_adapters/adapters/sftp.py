...
class SFTPAdapter:
    ...
    async def write_file(self, root: str, rel: str, data: bytes):
        ...
        await logging_service.info("adapter:sftp", f"Wrote file to {rel}", details={"adapter_id": self.record.id, "path": path, "size": len(data)})
    ...
    async def mkdir(self, root: str, rel: str):
        ...
        await logging_service.info("adapter:sftp", f"Created directory {rel}", details={"adapter_id": self.record.id, "path": path})
    ...
    async def delete(self, root: str, rel: str):
        ...
        await logging_service.info("adapter:sftp", f"Deleted {rel}", details={"adapter_id": self.record.id, "path": path})
    ...
    async def move(self, root: str, src_rel: str, dst_rel: str):
        ...
        await logging_service.info("adapter:sftp", f"Moved {src_rel} to {dst_rel}", details={"adapter_id": self.record.id, "src": src, "dst": dst})
    ...
    async def copy(self, root: str, src_rel: str, dst_rel: str, overwrite: bool = False):
        ...
        if await asyncio.to_thread(_is_dir):
            ...
            await logging_service.info("adapter:sftp", f"Copied directory {src_rel} to {dst_rel}", details={"adapter_id": self.record.id, "src": src, "dst": dst})
            return
        ...
        await logging_service.info("adapter:sftp", f"Copied {src_rel} to {dst_rel}", details={"adapter_id": self.record.id, "src": src, "dst": dst})
