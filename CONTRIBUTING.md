...
2. Implement a class that inherits from [`infrastructure.storage_adapters.base.BaseAdapter`](infrastructure/storage_adapters/base.py) and provide concrete implementations for the abstract methods such as `list_dir`, `get_meta`, `upload`, and `download`.
